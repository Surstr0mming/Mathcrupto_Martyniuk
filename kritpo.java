...
public class kritpo {
    public static void main(String[] args) {
        ...
        if (k > 0) {
            ...
            //нормальні знінні через рефактор
            //коменти закинути по кроках
            ...
            for (int i_n = 0; i_n < k - 1; i_n++) {
                i_while = 1;
                long n2 = n2_while + (i_while - 1) * d_n;
                while ((n2_while + (i_while - 1) * d_n) % myArray_of_divider[i_n + 1] !=
                        myArray_of_remainder[i_n + 1]
                        && i_while < myArray_of_divider[i_n + 1] + 1) {
                    n2 = n2_while + (i_while) * d_n;
                    i_while++;
                }
                System.out.println("Step number " + (i_n + 2));
                System.out.println("N_n = " + n2);
                n2_while = n2;
