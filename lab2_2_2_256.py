...
for glob in range(1000):
    ...
    for i in range(14):
        ...
        w7_new = slov.get(w7[0]) + slov.get(w7[1]) + slov.get(w7[2]) + slov.get(w7[3]) + slov.get(w7[4]) + slov.get(
            w7[5]) + \
        ...
        z3 = slov1.get(z3[:4]) + slov1.get(z3[4:8]) + slov1.get(z3[8:12]) + slov1.get(z3[12:16]) + slov1.get(
            z3[16:20]) + slov1.get(z3[20:24]) + slov1.get(z3[24:28]) + slov1.get(z3[28:32])

        z3 = S_BOX.get(z3[:2]) + S_BOX.get(z3[2:4]) + S_BOX.get(z3[4:6]) + S_BOX.get(z3[6:8])

        z3 = slov.get(z3[0]) + slov.get(z3[1]) + slov.get(z3[2]) + slov.get(z3[3]) + slov.get(z3[4]) + slov.get(
            z3[5]) + slov.get(z3[6]) + slov.get(z3[7])
