...
for i in range(12):
    ...
    w5_new = slov.get(w5[0]) + slov.get(w5[1]) + slov.get(w5[2]) + slov.get(w5[3]) + slov.get(w5[4]) + slov.get(w5[5]) + slov.get(w5[6]) + slov.get(w5[7])
    z = ''
    ...
    if (i == 0):
        ...
        nnnn = new_key
        mas_mas1 = new_new_key
        print("mmmmmmmmmmmmm ", mas_mas1)
    elif (i == 2):
        ...
        mas_mas[1] = new_new_key
        print("uuuuuuuuuuuuu", mas_mas[1])
    elif (i == 11):
...
for i in range(2):
    # 4
    # XORroundkey
    print("ggggggggggggggggggg ", round_mas)

    for i_new in range(4):
        for i_new_new in range(4):
            crypted_mas[i_new][i_new_new] = slov.get(crypted_mas[i_new][i_new_new][0]) + slov.get(
                crypted_mas[i_new][i_new_new][1])
